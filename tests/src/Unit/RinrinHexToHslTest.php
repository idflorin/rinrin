...
namespace Drupal\Tests\rinrin\Unit;

use Drupal\Tests\UnitTestCase;

/**
 * Tests the _rinrin_hex_to_hsl() function.
 *
 * @group rinrin
 */
final class RinrinHexToHslTest extends UnitTestCase {
  ...
  public function setUp(): void {
    parent::setUp();
    require_once __DIR__ . '/../../../rinrin.theme';
  }
  ...
  public function testHexToHsl(string $hex, array $expected_hsl): void {
    self::assertEquals($expected_hsl, _rinrin_hex_to_hsl($hex));
  }
