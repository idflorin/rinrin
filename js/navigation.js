...
((Drupal, once, tabbable) => {
  ...
  function init(props) {
    ...
    document.addEventListener('keyup', (e) => {
      if (e.key === 'Escape') {
        if (props.rinrin.areAnySubNavsOpen()) {
          props.rinrin.closeAllSubNav();
        } else {
   ...
   */
  Drupal.behaviors.rinrinNavigation = {
    attach(context) {
