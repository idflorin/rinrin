...
((Drupal) => {
  const { isDesktopNav } = Drupal.rinrin;
  ...
  Drupal.rinrin.toggleSubNav = toggleSubNav;
  ...
  function handleBlur(e) {
    if (!Drupal.rinrin.isDesktopNav()) return;
  ...
  Drupal.rinrin.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.rinrin.areAnySubNavsOpen = areAnySubNavsOpen;
